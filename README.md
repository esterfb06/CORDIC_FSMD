...
Inicialmente, o objetivo do nosso Sistema Digital englobava também o calculo de tangente do ângulo selecionado. Teorizamos dois métodos:
   ...
   * *Método em paralelo:* Pensamos tambem em fazer uma mémoria com os valores da tangente respectivos de cada arctangente ultilizado nas iterações (lembrando que os valores de ArcTg são dados de tal modo que valores de Tangente ultilizados dão no formato 2^-i (45, 26, etc.). Usando 16 iterações o valor terórico máximo que nosso sistema poderia calcular seria de 1,9999 (o somatório de 2^-i, com i=16 dá aproximemte 1,9999), e arctg(1,999) é aproximadamente 63 graus. Porém, em nossos testes o cálculo da tangente por este método não funcionou por motivos que, infelizmente, não tivemos tempo de investigar    
