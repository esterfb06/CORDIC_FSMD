...
-- Responsável por gerar os sinais de controle para o bloco operativo (BO),
...
begin
    ...
    LPE: process(estadoAtual, iniciar, menor)
    begin
        Case estadoAtual is
            When S0 =>
                if iniciar = '1' then
    ...
    LS: process(estadoAtual, z_sign)
    begin
        -- Inicializacao de todos os sinais de controle
        pronto      <= '0';
        zi          <= '0';
        ci          <= '0';
        init_sel    <= '0';
